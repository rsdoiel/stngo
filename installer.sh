...
PACKAGE="stn"
VERSION="v0.0.13"
RELEASE="https://github.com/$GIT_USER_OR_GROUP/$REPO_NAME/releases/tag/$VERSION"
...
#
DOWNLOAD_URL="https://github.com/$GIT_USER_OR_GROUP/$REPO_NAME/releases/download/$VERSION/$ZIPFILE"
